            ...
            <div class="container py-5">
              <div class="row g-4 mb-5">
                ...
                <div class="col-lg-8 col-xl-9">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a> / Chi tiết sản phẩm</li>
                  </ol>
                  <div class="row g-4">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                      <div class="mb-4">
                        ...
                        <ul class="list-unstyled fruite-categorie">
                          <c:forEach var="product" items="${factoryCount}">
                            <li>
                              <div class="d-flex justify-content-between fruite-name">
                                <a href="#"><i class="fas  me-2"></i>${product[0]}</a>
                                <span>Số lượng: (${product[1]})</span>
                              </div>
                            </li>
                          </c:forEach>
                        </ul>
              ...
              <h1 class="fw-bold mb-0">Products đề xuất</h1>
              <div class="vesitable">
                <div class="owl-carousel vegetable-carousel justify-content-center">
                  <c:forEach var="randomproduct" items="${randomProducts}">
                    <div class="border border-primary rounded position-relative vesitable-item">
                      <div class="vesitable-img">
                        <img src="/images/product/${randomproduct.image}" class="img-fluid w-100 rounded-top" alt="">
                      </div>
